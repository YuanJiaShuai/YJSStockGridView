...
@class YJSStockGridViewCell;
@protocol YJSStockGridViewCellDataSource <NSObject>
...
- (void)gridViewCell:(YJSStockGridViewCell *)cell didScroll:(UIScrollView *)scrollView;
...
/// 网格Cell
@interface YJSStockGridViewCell : UITableViewCell<UICollectionViewDelegate>

/// 数据源
@property (nonatomic, weak) id<YJSStockGridViewCellDataSource> dataSource;
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style
              reuseIdentifier:(nullable NSString *)reuseIdentifier
                   dataSource:(nullable id<YJSStockGridViewCellDataSource>)dataSource;
- (instancetype)initWithStyle:(UITableViewCellStyle)style
